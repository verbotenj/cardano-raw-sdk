 ...
 */
export type ParamsForOperation<T extends TransactionType> = Extract<OperationRequest, {
    type: T;
}>["params"];
/**
 * Extract result type for a specific operation type
 */
export type ResultForOperation<T extends TransactionType> = Extract<OperationResult, {
    type: T;
}>["result"];
/**
...
export type VaultBalanceResponse = VaultBalanceSummary | VaultBalanceTokenResponse | VaultBalanceAddressResponse | VaultBalancePolicyResponse;
/**
