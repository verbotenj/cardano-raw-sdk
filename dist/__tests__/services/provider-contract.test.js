...
import { ChainProviderCapability, Networks, ProviderCapabilityError, } from "../../types/index.js";
describe("chain provider contract", () => {
    ...
    it("keeps IAGON as a full-capability provider", () => {
        const provider = new IagonApiService("iagon-test-key", Networks.PREVIEW);
    ...
    it("keeps IAGON compatible with the provider-neutral core contract", async () => {
        ...
        await expect(provider.getBalanceByAddress({ address: "addr_test1contract", groupByPolicy: false })).resolves.toEqual({ success: true, data: { lovelace: 3_000_000, assets: {} } });
