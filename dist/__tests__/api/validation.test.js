...
import { z } from "zod";
import { vaultAccountIdParamsSchema, poolIdParamsSchema, credentialParamsSchema, hashParamsSchema, consolidateUtxosRequestSchema, registerStakingRequestSchema, deregisterStakingRequestSchema, delegateToPoolRequestSchema, withdrawRewardsRequestSchema, registerAsDRepRequestSchema, castVoteRequestSchema, } from "../../api/validation.js";
describe("vaultAccountIdParamsSchema", () => {
    ...
    it("should reject empty string", () => {
        expect(() => vaultAccountIdParamsSchema.parse({ vaultAccountId: "" })).toThrow(z.ZodError);
    });
...
describe("credentialParamsSchema", () => {
    ...
    it("should reject empty vaultAccountId", () => {
        expect(() => credentialParamsSchema.parse({ vaultAccountId: "", credential: "abc" })).toThrow(z.ZodError);
    });
    it("should reject empty credential", () => {
        expect(() => credentialParamsSchema.parse({ vaultAccountId: "123", credential: "" })).toThrow(z.ZodError);
    });
    it("should reject missing fields", () => {
        expect(() => credentialParamsSchema.parse({ vaultAccountId: "123" })).toThrow(z.ZodError);
...
describe("consolidateUtxosRequestSchema", () => {
    ...
    it("should reject missing vaultAccountId", () => {
        expect(() => consolidateUtxosRequestSchema.parse({ index: 0 })).toThrow(z.ZodError);
    });
    it("should reject negative index", () => {
        expect(() => consolidateUtxosRequestSchema.parse({ vaultAccountId: "0", index: -1 })).toThrow(z.ZodError);
    });
    it("should reject non-integer index", () => {
        expect(() => consolidateUtxosRequestSchema.parse({ vaultAccountId: "0", index: 1.5 })).toThrow(z.ZodError);
    });
    it("should reject minUtxoCount less than 2", () => {
        expect(() => consolidateUtxosRequestSchema.parse({ vaultAccountId: "0", minUtxoCount: 1 })).toThrow(z.ZodError);
    });
});
describe("registerStakingRequestSchema", () => {
    ...
    it("should reject negative index", () => {
        expect(() => registerStakingRequestSchema.parse({ vaultAccountId: "0", index: -1 })).toThrow(z.ZodError);
    });
    it("should reject non-integer index", () => {
        expect(() => registerStakingRequestSchema.parse({ vaultAccountId: "0", index: 2.5 })).toThrow(z.ZodError);
    });
});
describe("deregisterStakingRequestSchema", () => {
    ...
    it("should reject empty vaultAccountId", () => {
        expect(() => deregisterStakingRequestSchema.parse({ vaultAccountId: "" })).toThrow(z.ZodError);
    });
    it("should reject missing vaultAccountId", () => {
...
describe("delegateToPoolRequestSchema", () => {
    ...
    it("should reject missing poolId", () => {
        expect(() => delegateToPoolRequestSchema.parse({ vaultAccountId: "0" })).toThrow(z.ZodError);
    });
    it("should reject missing vaultAccountId", () => {
        expect(() => delegateToPoolRequestSchema.parse({ poolId: "pool1abc" })).toThrow(z.ZodError);
    });
    it("should reject empty poolId", () => {
        expect(() => delegateToPoolRequestSchema.parse({ vaultAccountId: "0", poolId: "" })).toThrow(z.ZodError);
    });
    it("should reject empty vaultAccountId", () => {
        expect(() => delegateToPoolRequestSchema.parse({ vaultAccountId: "", poolId: "pool1abc" })).toThrow(z.ZodError);
    });
});
describe("withdrawRewardsRequestSchema", () => {
    ...
    it("should reject negative limit", () => {
        expect(() => withdrawRewardsRequestSchema.parse({ vaultAccountId: "0", limit: -3 })).toThrow(z.ZodError);
    });
    it("should reject zero limit", () => {
        expect(() => withdrawRewardsRequestSchema.parse({ vaultAccountId: "0", limit: 0 })).toThrow(z.ZodError);
    });
});
describe("registerAsDRepRequestSchema", () => {
    ...
    it("should reject invalid anchor URL", () => {
        expect(() => registerAsDRepRequestSchema.parse({
            vaultAccountId: "0",
            anchor: {
                url: "not-a-url",
                dataHash: "a".repeat(64),
    ...
    it("should reject negative depositAmount", () => {
        expect(() => registerAsDRepRequestSchema.parse({ vaultAccountId: "0", depositAmount: -1 })).toThrow(z.ZodError);
    });
});
describe("castVoteRequestSchema", () => {
    ...
    it("should reject missing vaultAccountId", () => {
        expect(() => castVoteRequestSchema.parse({
            governanceActionId: {
                txHash: "a".repeat(64),
                index: 0,
            },
