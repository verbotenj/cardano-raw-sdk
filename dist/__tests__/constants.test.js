...
import { iagonBaseUrl, CardanoConstants, CardanoAmounts, FireblocksWebhookConstants, } from "../constants.js";
...
describe("CardanoAmounts", () => {
    ...
    describe("Transaction fees", () => {
        ...
        it("should have governance fee >= staking fee", () => {
            expect(CardanoAmounts.GOVERNANCE_TX_FEE).toBeGreaterThanOrEqual(CardanoAmounts.STAKING_TX_FEE);
        });
    });
    describe("DRep registration", () => {
        ...
        it("should be significantly larger than stake deposit", () => {
            expect(CardanoAmounts.DREP_REGISTRATION_DEPOSIT).toBeGreaterThan(CardanoAmounts.DEPOSIT_AMOUNT * 100);
        });
    });
    describe("Fee estimation", () => {
        ...
        it("should have tolerance less than initial estimate", () => {
            expect(CardanoAmounts.TX_FEE_TOLERANCE).toBeLessThan(CardanoAmounts.TX_FEE_INITIAL_ESTIMATE);
        });
    });
...
describe("FireblocksWebhookConstants", () => {
    describe("JWKS Endpoints", () => {
        ...
        it("should have Sandbox JWKS endpoint", () => {
            ...
            expect(FireblocksWebhookConstants.JWKS_ENDPOINTS.SANDBOX).toContain("sandbox-keys.fireblocks.io");
        });
    ...
    describe("Headers", () => {
        it("should have JWKS signature header name", () => {
            expect(FireblocksWebhookConstants.HEADERS.JWKS_SIGNATURE).toBe("fireblocks-webhook-signature");
        });
        it("should have legacy signature header name", () => {
            expect(FireblocksWebhookConstants.HEADERS.LEGACY_SIGNATURE).toBe("fireblocks-signature");
        });
        it("should have different header names for JWKS vs legacy", () => {
            expect(FireblocksWebhookConstants.HEADERS.JWKS_SIGNATURE).not.toBe(FireblocksWebhookConstants.HEADERS.LEGACY_SIGNATURE);
        });
    });
});
