...
export const transferRequestSchema = z
    ...
    return (data.recipientAddress !== undefined ||
        data.recipientVaultAccountId !== undefined ||
        data.recipientIndex !== undefined ||
        data.index !== undefined);
}, {
    message: "At least one recipient must be specified: recipientAddress, recipientVaultAccountId, recipientIndex, or index",
});
/**
...
export const feeEstimationRequestSchema = z
    ...
    message: "Exactly one recipient must be specified: recipientAddress OR recipientVaultAccountId (not both)",
});
...
const adaRecipientRefinementMessage = "Exactly one recipient must be specified: recipientAddress OR recipientVaultAccountId (not both, not neither)";
...
const multiTokenRecipientMessage = "Exactly one recipient must be specified: recipientAddress OR recipientVaultAccountId (not both, not neither)";
...
export const delegateToDRepRequestSchema = z
    ...
    drepId: z
        .string()
        .regex(/^(drep1|drep_script1)[a-z0-9]+$|^[0-9a-fA-F]{56}$/, "drepId must be bech32 (drep1... or drep_script1...) or a 56-character hex string")
        .optional(),
