...
import { validateRequest, validateParams, validateQuery, addressQuerySchema, txHistoryQuerySchema, paginationQuerySchema, transferRequestSchema, feeEstimationRequestSchema, adaTransferRequestSchema, adaFeeEstimationRequestSchema, multiTokenTransferRequestSchema, multiTokenFeeEstimationRequestSchema, consolidateUtxosRequestSchema, delegateToDRepRequestSchema, registerAsDRepRequestSchema, castVoteRequestSchema, registerStakingRequestSchema, deregisterStakingRequestSchema, delegateToPoolRequestSchema, withdrawRewardsRequestSchema, vaultAccountIdParamsSchema, credentialParamsSchema, hashParamsSchema, poolIdParamsSchema, } from "./validation.js";
export const configureRouter = (sdkManager) => {
    const router = Router();
     ...
     */
    router.get("/balance/address/:vaultAccountId", validateParams(vaultAccountIdParamsSchema), validateQuery(addressQuerySchema), apiController.getBalanceByAddress);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.get("/balance/credential/:vaultAccountId/:credential", validateParams(credentialParamsSchema), apiController.getBalanceByCredential);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.get("/balance/stake/:vaultAccountId", validateParams(vaultAccountIdParamsSchema), apiController.getBalanceByStakeKey);
    /**
     * TRANSACTIONS
     */
    /**
     ...
     *         description: Internal server error
     */
    router.get("/utxos/:vaultAccountId", validateParams(vaultAccountIdParamsSchema), validateQuery(addressQuerySchema), apiController.getUtxosByAddress);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.get("/utxos/:vaultAccountId/all", validateParams(vaultAccountIdParamsSchema), apiController.getVaultUtxos);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.get("/tx/history/:vaultAccountId/all", validateParams(vaultAccountIdParamsSchema), validateQuery(txHistoryQuerySchema), apiController.getAllTransactionHistory);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.get("/tx/history/:vaultAccountId", validateParams(vaultAccountIdParamsSchema), validateQuery(txHistoryQuerySchema), apiController.getTransactionHistory);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.get("/tx/address/:vaultAccountId/all", validateParams(vaultAccountIdParamsSchema), validateQuery(txHistoryQuerySchema), apiController.getAllDetailedTxHistory);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.get("/tx/address/:vaultAccountId", validateParams(vaultAccountIdParamsSchema), validateQuery(txHistoryQuerySchema), apiController.getDetailedTxHistory);
    /**
     * @swagger
     * /api/transfers:
     *   post:
     ...
     *         description: Internal server error
     */
    router.post("/fee-estimate/ada", validateRequest(adaFeeEstimationRequestSchema), apiController.estimateAdaFee);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.post("/transfers/tokens", validateRequest(multiTokenTransferRequestSchema), apiController.transferMultipleTokens);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.post("/fee-estimate/tokens", validateRequest(multiTokenFeeEstimationRequestSchema), apiController.estimateMultiTokenFee);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.post("/utxos/consolidate", validateRequest(consolidateUtxosRequestSchema), apiController.consolidateUtxos);
    /**
     * WEBHOOK
     */
    /**
     ...
     *         description: Internal server error
     */
    router.post("/staking/register", validateRequest(registerStakingRequestSchema), apiController.registerStaking);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.post("/staking/deregister", validateRequest(deregisterStakingRequestSchema), apiController.deregisterStaking);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.post("/staking/delegate", validateRequest(delegateToPoolRequestSchema), apiController.delegateToPool);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.post("/staking/withdraw-rewards", validateRequest(withdrawRewardsRequestSchema), apiController.withdrawRewards);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.post("/governance/delegate-drep", validateRequest(delegateToDRepRequestSchema), apiController.delegateToDRep);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.post("/governance/register-drep", validateRequest(registerAsDRepRequestSchema), apiController.registerAsDRep);
    /**
     * @swagger
     * /api/governance/vote:
     *   post:
     ...
     *         description: Internal server error
     */
    router.post("/governance/vote", validateRequest(castVoteRequestSchema), apiController.castGovernanceVote);
    /**
     * NETWORK
     */
    /**
     ...
     *         description: Internal server error
     */
    router.get("/pools/:poolId/metadata", validateParams(poolIdParamsSchema), apiController.getPoolMetadata);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.get("/pools/:poolId/delegators", validateParams(poolIdParamsSchema), apiController.getPoolDelegators);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.get("/pools/:poolId/delegators/list", validateParams(poolIdParamsSchema), validateQuery(paginationQuerySchema), apiController.getPoolDelegatorsList);
    /**
     * @swagger
     ...
     *         description: Internal server error
     */
    router.get("/pools/:poolId/blocks", validateParams(poolIdParamsSchema), apiController.getPoolBlocks);
    return router;
};
