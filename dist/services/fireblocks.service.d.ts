import { ConfigurationOptions as FireblocksConfig, SignedMessageSignature, TransactionRequest, SignedMessageAlgorithmEnum, VaultWalletAddress, TransactionResponse } from "@fireblocks/ts-sdk";
...
export declare class FireblocksService {
     ...
     */
    getVaultAccountAddress: (vaultAccountId: string, assetId: string, index?: number) => Promise<VaultWalletAddress>;
    /**
     ...
     */
    getVaultAccountAddresses: (vaultAccountId: string, assetId: string) => Promise<VaultWalletAddress[]>;
    /**
     ...
     */
    signTransaction: (transactionPayload: TransactionRequest) => Promise<FireblocksSigningResponse | null>;
     ...
     */
    getAssetPublicKey: (vaultAccountId: string, assetId: string, change?: number, addressIndex?: number) => Promise<string>;
}
//# sourceMappingURL=fireblocks.service.d.ts.map