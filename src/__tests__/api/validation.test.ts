...
describe("credentialParamsSchema", () => {
  ...
  it("should reject empty vaultAccountId", () => {
    expect(() => credentialParamsSchema.parse({ vaultAccountId: "", credential: "abc" })).toThrow(
      z.ZodError
    );
  });

  it("should reject empty credential", () => {
    expect(() => credentialParamsSchema.parse({ vaultAccountId: "123", credential: "" })).toThrow(
      z.ZodError
    );
  });
...
describe("consolidateUtxosRequestSchema", () => {
  ...
  it("should reject negative index", () => {
    expect(() => consolidateUtxosRequestSchema.parse({ vaultAccountId: "0", index: -1 })).toThrow(
      z.ZodError
    );
  });

  it("should reject non-integer index", () => {
    expect(() => consolidateUtxosRequestSchema.parse({ vaultAccountId: "0", index: 1.5 })).toThrow(
      z.ZodError
    );
  });
...
describe("registerStakingRequestSchema", () => {
  ...
  it("should reject negative index", () => {
    expect(() => registerStakingRequestSchema.parse({ vaultAccountId: "0", index: -1 })).toThrow(
      z.ZodError
    );
  });

  it("should reject non-integer index", () => {
    expect(() => registerStakingRequestSchema.parse({ vaultAccountId: "0", index: 2.5 })).toThrow(
      z.ZodError
    );
  });
});
...
describe("delegateToPoolRequestSchema", () => {
  ...
  it("should reject empty poolId", () => {
    expect(() => delegateToPoolRequestSchema.parse({ vaultAccountId: "0", poolId: "" })).toThrow(
      z.ZodError
    );
  });
...
describe("withdrawRewardsRequestSchema", () => {
  ...
  it("should reject negative limit", () => {
    expect(() => withdrawRewardsRequestSchema.parse({ vaultAccountId: "0", limit: -3 })).toThrow(
      z.ZodError
    );
  });

  it("should reject zero limit", () => {
    expect(() => withdrawRewardsRequestSchema.parse({ vaultAccountId: "0", limit: 0 })).toThrow(
      z.ZodError
    );
  });
});
